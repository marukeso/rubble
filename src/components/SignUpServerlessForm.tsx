  ...
  return (
    <SimpleGrid cols={1} spacing={6}>
      ...
      >
        ...
        the link to complete authentication. This page will automatically
        redirect you to the authenticated home page once the email has been
        verified.
      </Modal>
      <TextInput
        type="email"
