...
export interface customers_bool_exp {
...
export interface customers_insert_input {
  id?: InputMaybe<Scalars["uuid"]>;
  name?: InputMaybe<Scalars["String"]>;
}

/** on_conflict condition type for table "customers" */
export interface customers_on_conflict {
...
export interface customers_order_by {
  id?: InputMaybe<order_by>;
  name?: InputMaybe<order_by>;
}

/** primary key columns input for table: customers */
export interface customers_pk_columns_input {
  id: Scalars["uuid"];
}
...
export interface customers_set_input {
  id?: InputMaybe<Scalars["uuid"]>;
  name?: InputMaybe<Scalars["String"]>;
}
...
export const scalarsEnumsHash: import("gqty").ScalarsEnumsHash = {
  ...
  citext: true,
  customers_constraint: true,
  customers_select_column: true,
  customers_update_column: true,
...
export const generatedSchema = {
  ...
  customers_aggregate: {
    __typename: { __type: "String!" },
    aggregate: { __type: "customers_aggregate_fields" },
    nodes: { __type: "[customers!]!" },
  },
  customers_aggregate_fields: {
    __typename: { __type: "String!" },
    count: {
      __type: "Int!",
      __args: { columns: "[customers_select_column!]", distinct: "Boolean" },
    },
    max: { __type: "customers_max_fields" },
    min: { __type: "customers_min_fields" },
  },
  customers_bool_exp: {
    _and: { __type: "[customers_bool_exp!]" },
    _not: { __type: "customers_bool_exp" },
    _or: { __type: "[customers_bool_exp!]" },
    id: { __type: "uuid_comparison_exp" },
  ...
  customers_mutation_response: {
    __typename: { __type: "String!" },
    affected_rows: { __type: "Int!" },
    returning: { __type: "[customers!]!" },
  },
  customers_on_conflict: {
    constraint: { __type: "customers_constraint!" },
    update_columns: { __type: "[customers_update_column!]!" },
    where: { __type: "customers_bool_exp" },
  },
  customers_order_by: {
    id: { __type: "order_by" },
    name: { __type: "order_by" },
  },
  customers_pk_columns_input: { id: { __type: "uuid!" } },
  customers_set_input: { id: { __type: "uuid" }, name: { __type: "String" } },
  files: {
    __typename: { __type: "String!" },
  ...
  mutation: {
    ...
    delete_customers: {
      __type: "customers_mutation_response",
      __args: { where: "customers_bool_exp!" },
    },
    delete_customers_by_pk: { __type: "customers", __args: { id: "uuid!" } },
    insertAuthProvider: {
    ...
    update_customers: {
      __type: "customers_mutation_response",
      __args: { _set: "customers_set_input", where: "customers_bool_exp!" },
    },
  ...
  query: {
    ...
    customers_by_pk: { __type: "customers", __args: { id: "uuid!" } },
...
export interface Mutation {
  ...
  delete_customers: (args: {
    where: customers_bool_exp;
  }) => Maybe<customers_mutation_response>;
  delete_customers_by_pk: (args: { id: Scalars["uuid"] }) => Maybe<customers>;
...
export interface Query {
  ...
  customers_by_pk: (args: { id: Scalars["uuid"] }) => Maybe<customers>;
...
export interface ScalarsEnums extends MakeNullable<Scalars> {
  ...
  customers_constraint: customers_constraint | undefined;
  customers_select_column: customers_select_column | undefined;
  customers_update_column: customers_update_column | undefined;
